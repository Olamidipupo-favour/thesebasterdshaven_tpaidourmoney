      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-2">{boxInfo.name}</h1>
              <p className="text-muted-foreground">{boxInfo.description}</p>
            </div>
              ...
              <div className="p-6">
                {!wonPrize && !isSpinning && !isDemoSpinning ? (
                    ...
                    <div className="relative mx-auto w-80 h-80">
                      <div className="w-full h-full bg-gradient-to-br from-primary/10 to-secondary/10 rounded-2xl flex items-center justify-center border-2 border-primary/20 relative overflow-hidden">
                        ...
                        <div className="relative z-10 text-center">
                          ...
                          <h2 className="text-2xl font-bold text-foreground mb-2">{boxInfo.name}</h2>
                  ...
                  <div className="text-center space-y-6">
                    ...
                    {/* Scrolling Items Display - Rillabox Style */}
          ...
          <div className="space-y-6">
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-foreground">${boxInfo.price} / {boxInfo.coinPrice} Coins</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Items:</span>
                    <span className="font-bold text-foreground">{boxInfo.items} iPhones</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Total Value:</span>
                    <span className="font-bold text-primary">${boxInfo.totalValue.toLocaleString()}</span>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <Card className="bg-card border-border">
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold text-foreground">Items in Box</h3>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                {showItems && (
                  <div className="space-y-3 max-h-96 overflow-y-auto">
                    {iphoneItems.map((item) => (
                      <div key={item.id} className="flex items-center space-x-3 p-2 bg-muted/20 rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-muted-foreground">{item.probability}% chance</div>
                        </div>
                        <div className="text-right">
                          <div className="text-sm font-bold text-primary">${item.value}</div>
                          <div className={`w-2 h-2 rounded-full ${rarityColors[item.rarity]} ml-auto`}></div>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <Card className="bg-card border-border">
              <div className="p-6">
                ...
                <div className="space-y-3">
                  {[
                    { user: "Player1", item: "iPhone 15 Pro", value: "$999", time: "2 min ago" },
                    { user: "Player2", item: "iPhone 14 Pro Max", value: "$1099", time: "5 min ago" },
                    { user: "Player3", item: "iPhone 13 Pro", value: "$799", time: "8 min ago" },
                  ].map((win, index) => (

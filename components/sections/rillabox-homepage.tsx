  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <section className="w-full mb-4 md:mb-6">
        <div className="grid grid-cols-12 items-stretch gap-x-0 md:gap-x-4 gap-y-3 md:gap-y-0">
          {/* Left: Slider */}
          <div className="col-span-12 md:col-span-8 h-auto pl-0">
            <div className="relative w-full overflow-hidden rounded-xl min-h-[140px] sm:min-h-[160px] md:min-h-[200px] lg:min-h-[220px]">
              {/* Slides */}
              <div className="relative w-full h-[140px] sm:h-[160px] md:h-[200px] lg:h-[220px]">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center justify-center sm:justify-start gap-3 mb-2 sm:mb-0 mx-auto sm:mx-0">
              <div className="w-14 h-14 md:w-10 md:h-10 rounded-lg bg-[#0f2a1f] border border-[#1f6b4a] flex items-center justify-center shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-9 h-9 md:w-6 md:h-6 text-[#22c55e]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="5" width="20" height="14" rx="2"></rect><line x1="2" y1="9" x2="22" y2="9"></line></svg>
              </div>
            ...
            {/* Desktop: retain existing layout */}
            <div className="hidden sm:grid grid-cols-4 lg:grid-cols-8 gap-3 sm:gap-4 w-full sm:w-auto">

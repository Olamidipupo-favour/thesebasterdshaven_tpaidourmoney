    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-card border-t border-border">
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-3 gap-2 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))]">
          ...
          <Link href="/weekly-race" className="flex flex-col items-center gap-1 text-xs py-1">
            <Trophy className="w-5 h-5" />
            <span>Prizes</span>
          </Link>
          <Link href="/boxes" className="flex flex-col items-center gap-1 text-xs py-1" onClick={closeGamesMenu}>
